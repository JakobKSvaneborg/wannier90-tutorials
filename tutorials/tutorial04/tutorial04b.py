"""
Tutorial 04b: Verifying localization from a scrambled initial guess (Copper)
============================================================================

Companion to tutorial 04. FCC Copper with 7 Wannier functions (5d + 2s)
extracted from 12 bands (disentanglement). We apply a k-dependent random
unitary transformation and verify that the optimizer recovers the same minimum.
"""
...
seed = tutorial_dir / 'copper'

print("=" * 65)
print("  Tutorial 04b: Localization from a scrambled initial guess")
print("  System: Copper, 7 WFs (5d + 2s) from 12 bands")
print("=" * 65)
print()
...
try:
    ...
    ax.set_title('Tutorial 04b: Copper — Convergence from good vs scrambled start')
    ax.legend(fontsize=9)
    ax.grid(True, alpha=0.3)
    fig.tight_layout()

    plot_path = tutorial_dir / 'tutorial04b_convergence.png'
